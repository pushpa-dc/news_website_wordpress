<div class="wrap">
  ...
  <div class="row">
    <div class="col-md-12">
        <?php $i=0; $args = array('showposts' => 2, 'cat' => '-15'); $loop = new WP_Query( $args ); while($loop->have_posts()): $loop->the_post(); if($i++<1){?>
        <div class="key">
          <a href="<?php the_permalink();?>">
            <figure>
              ...
              <div class="overlay-title1 p-3">
                <h5 class="pt-3"><?php the_title();?></h5>
                <i class="fa fa-clock-o" aria-hidden="true"></i>
                <span class="">
                  <?php echo get_the_date();?>
                  <?php //echo get_nepali_post_date(get_the_date());?></span>
              </div>
            </figure>
          </a>
        </div>
      ...
      <div class="col-md-12 custom-list">
        <div class="media p-3 small-list">
          <div class="mr-3">
            <figure>

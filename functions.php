...
// 	'menu-1' => esc_html__( 'Primary', 'navigation' ),
// 	'menu-2' => esc_html__( 'Footer Mnu', 'nepali-news-portal' ),
// 	'menu-3' => esc_html__( 'Footer Menu 1', 'nepali-news-portal' ),
// ) );
...
function appharu_widgets_init() {
	$widgets = array(
		array('id' => 'single-sidebar','name'=>'Single page right side bar ads' ),
		array('id' => 'logo-right','name'=>'Logo Right' ),
  array('id' => 'top-banner','name'=>'Top Banner' ),
  array('id' => 'bottom-banner','name'=>'Bottom banner' ),
		array('id' => 'bottom-nav','name'=>'Bottom navbar' ),
  array('id' => 'scomment','name'=>'single page comment' ),
...
function appharu_scripts() {
	...
	wp_enqueue_style( 'appharu-style', get_stylesheet_uri(),array(),'5.0' );
	...
	wp_enqueue_script( 'custom-js', get_stylesheet_directory_uri() . '/js/script.js', array(), '1.72', true );
}
